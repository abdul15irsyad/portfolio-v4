  ...
  [
    {
      ...
      challenges: [
        {
          translates: [
            {
              lang: 'id',
              desc: 'Mempelajari struktur dan fitur project',
            },
            {
              lang: 'en',
              desc: 'Learning project structure and features',
            },
          ],
        },
        {
          translates: [
            {
              lang: 'id',
              desc: 'Rekonsiliasi banyak transaksi dari produk lain',
            },
            {
              lang: 'en',
              desc: 'Reconciliate many transactions from other products',
            },
          ],
        },
        {
          translates: [
            {
              lang: 'id',
              desc: 'Membuat cron job untuk task baru',
            },
            {
              lang: 'en',
              desc: 'Create a cron job for a new task',
            },
          ],
        },
      ],
      ...
      images: [...Array(4).keys()].map((_, index) => ({
        ...
        alt: `Transaction Reconciliation & EXchange (v1) ${index + 1}`,
      })),
      teams: [
        {
          // rexy
